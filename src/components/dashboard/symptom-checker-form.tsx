    ...
    <Card className="max-w-2xl mx-auto shadow-lg">
        <form action={formAction}>
            <CardHeader>
                ...
                <CardDescription>
                    Describe your symptoms, and our AI will provide a list of possible causes. This is for informational purposes only and not a medical diagnosis.
                </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
                ...
                {state.data && (
                    <Card className="bg-accent/50 border-accent">
                        ...
                        <CardContent>
                            <p className="text-sm text-accent-foreground whitespace-pre-line">{state.data}</p>
                        </CardContent>
                    </Card>
                )}
            </CardContent>
