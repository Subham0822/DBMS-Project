    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1">
          ...
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl">Comprehensive Medical Departments</h2>
                <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  We offer a wide range of specializations to cater to all your health needs.
                </p>
              </div>
            </div>
          ...
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
                <div className="space-y-2">
                    ...
                    <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl">Meet Our Doctors</h2>
                    <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
            ...
            <div className="mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 py-12">
              {initialDoctors.map((doctor) => (
                <Card key={doctor.id} className="text-center overflow-hidden transition-transform hover:scale-105 hover:shadow-xl">
        ...
        <section id="testimonials" className="w-full py-12 md:py-24 lg:py-32">
          <div className="container px-4 md:px-6">
            <h2 className="text-3xl font-bold tracking-tighter text-center sm:text-5xl mb-12">What Our Patients Say</h2>
            <div className="mx-auto grid gap-8 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
              <Card>
                <CardHeader>
                  <div className="flex items-center gap-4">
                    <Avatar>
                      <AvatarImage src="https://picsum.photos/seed/p1/100/100" alt="Patient" data-ai-hint="person happy" />
                ...
                <CardContent>
                  <p className="text-muted-foreground">"The care I received at MediSys was exceptional. The doctors were knowledgeable and the staff was incredibly friendly. Highly recommend!"</p>
                </CardContent>
              </Card>
              <Card>
                <CardHeader>
                  <div className="flex items-center gap-4">
                    <Avatar>
                      <AvatarImage src="https://picsum.photos/seed/p2/100/100" alt="Patient" data-ai-hint="person smiling"/>
                ...
                <CardContent>
                  <p className="text-muted-foreground">"Booking an appointment was so easy through their website. The whole process was smooth and efficient from start to finish."</p>
                </CardContent>
              </Card>
              <Card>
                <CardHeader>
                  <div className="flex items-center gap-4">
                    <Avatar>
                      <AvatarImage src="https://picsum.photos/seed/p3/100/100" alt="Patient" data-ai-hint="person content" />
                ...
                <CardContent>
                  <p className="text-muted-foreground">"A wonderful experience. The facilities are top-notch and every interaction I had was positive. I felt genuinely cared for."</p>
                </CardContent>
              </Card>
            </div>
          </div>
