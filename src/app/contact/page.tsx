                ...
                <div className="container px-4 md:px-6 grid gap-12 lg:grid-cols-2">
                    ...
                    <div className="space-y-8">
                        <div className="space-y-2">
                            ...
                            <p className="text-muted-foreground">Find us at our main campus or contact us directly.</p>
                        </div>
                        <div className="space-y-4">
                         ...
                         <div className="rounded-xl overflow-hidden">
                           <img src="https://picsum.photos/seed/map/600/400" alt="Map" className="w-full h-auto" data-ai-hint="map city" />
                        </div>
                    </div>
                </div>
            </section>
